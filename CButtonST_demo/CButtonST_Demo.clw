...
NewFileInclude2=#include "cbuttonst_demo.h"
LastPage=0

ClassCount=11
Class1=CBkDialog
Class2=CButtonST
Class3=CCButtonST_DemoApp
Class4=CCButtonST_DemoDlg
Class5=CDlgAbout
Class6=CDlgAdvanced
Class7=CDlgBasic
...
ResourceCount=8
Resource1=IDD_CBUTTONST_DEMO_DIALOG (Neutral)
Resource2=IDR_MENU (Neutral)
Resource3=IDD_ADVANCED (Neutral)
Resource4=IDD_ABOUT (Neutral)
Resource5=IDD_SHADED (Neutral)
Resource6=IDD_BASIC (Neutral)
Resource7=IDD_TRANSPARENT (Neutral)
Resource8=IDR_TOOLBAR (Neutral)

[CLS:CBkDialog]
Type=0
BaseClass=CDialog
HeaderFile=BkDialog.h
ImplementationFile=BkDialog.cpp
LastObject=CBkDialog
...
[CLS:CCButtonST_DemoApp]
Type=0
BaseClass=CWinApp
HeaderFile=CButtonST_Demo.h
ImplementationFile=CButtonST_Demo.cpp

[CLS:CCButtonST_DemoDlg]
Type=0
BaseClass=CDialog
HeaderFile=CButtonST_DemoDlg.h
ImplementationFile=CButtonST_DemoDlg.cpp
...
[DLG:IDD_CBUTTONST_DEMO_DIALOG]
Type=1
Class=CCButtonST_DemoDlg
...
[DLG:IDD_CBUTTONST_DEMO_DIALOG (Neutral)]
Type=1
Class=?
ControlCount=4
Control1=IDCANCEL,button,1342242816
Control2=IDC_TAB,SysTabControl32,1342177280
Control3=IDC_EMAILLINK,static,1342308352
Control4=IDC_HOMEPAGELINK,static,1342308352
...
Control8=IDC_BTNFOCUSRECT,button,1342242816
Control9=IDC_STATIC,button,1342177287
Control10=IDC_STATIC,button,1342177287
Control11=IDC_STATIC,button,1342177287
Control12=IDC_BTNBITMAP,button,1342242816
